package com.sa.anb.poc.controller;
...
import com.sa.anb.poc.client.UserClient;
import com.sa.anb.poc.model.User;
import com.sa.anb.poc.repository.UserRepository;
...
public class UserFeignController {
	...
	public ResponseEntity<User> createUser(@RequestBody User user) {
		try {
			...
			return new ResponseEntity<>(userClient.createUser(user), HttpStatus.CREATED);
	...
	public ResponseEntity<User> updateUser( @RequestBody User user) {
		try {
			...
			return new ResponseEntity<>(userClient.updateUser(user), HttpStatus.OK);
		} catch (Exception e) {
